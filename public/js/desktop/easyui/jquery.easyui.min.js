...
var cc=$(_343);
if(_344=="east"){
return {resizeC:{width:_346.center.panel("options").width+_346["east"].panel("options").width-8},expand:{left:cc.width()-_346["east"].panel("options").width},expandP:{top:_346["east"].panel("options").top,left:cc.width()-8,width:8,height:_346["center"].panel("options").height},collapse:{left:cc.width()}};
}else{
if(_344=="west"){
return {resizeC:{width:_346.center.panel("options").width+_346["west"].panel("options").width-8,left:8},expand:{left:0},expandP:{left:0,top:_346["west"].panel("options").top,width:8,height:_346["center"].panel("options").height},collapse:{left:-_346["west"].panel("options").width}};
}else{
if(_344=="north"){
var hh=cc.height()-28;
