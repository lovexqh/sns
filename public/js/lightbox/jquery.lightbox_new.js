	...
	$.fn.lightbox = function(options) {
		...
		*/
		function initialize() {
			...
			var outerImage = '<div id="outerImageContainer"><div id="imageContainer"><iframe id="lightboxIframe"></iframe><img id="lightboxImage" /><div id="hoverNav"><a href="javascript://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="loading"><a href="javascript://" id="loadingLink"><img src="'+opts.fileLoadingImage+'"></a></div></div><div id="infoContent">565656</div></div>';
		...
		*/
		...
		function showOwninfo(obj){
			var htmlid = $(obj).attr('id');
			var htmlidar = htmlid.split('_');
			if(htmlidar[1] != 0 && htmlidar[1] == 'undefined'){
				//Ajax get The Own infomation
				$.post(_ROOT_+'/index.php?app=home&mod=Picture&act=getowninfo',
						{uid:htmlidar[1],time:new Date().getTime()},
						function(data){
