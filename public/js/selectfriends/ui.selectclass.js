                ...
                _clickBind:function() {
                        ...
                        $($this.opts.btnNextPage).bind("click", function() {
                                if ($this.currentPage < $this.totalPage) {
                                        $this.currentPage++;
                                        $($this.opts.allFriendListContainer).html('数据加载中...');
                ...
                _getRecordCound:function(callBack){
                        ...
                        $.ajax({
                                ...
                                success:function(msg) {
                                        ...
                                        //改变总好友数
                                		$ui_fri_num.html((fnum < 50)?fnum:'50');
                                        $this.opts.totalSelectNum = (fnum < 50)?fnum:'50';
                                        //end
                                        var myData = eval(msg);
...
//                                        $($this.opts.frinedNumberContainer).text($this.opts.totalSelectNum- $this.resultArr.length);
     ...
     * */
        giant.ui.friendsuggest.defaults = {
                ...
                inputDefaultTip:"输入同学姓名(支持全拼输入)",
                noDataTip:"您的同学中不存在该同学",
                ajaxUrl:"ajax.asp",
