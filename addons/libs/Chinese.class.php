...
class Chinese
{
    ...
    function Chinese()
    {
        ...
        $this->config['codetable_dir'] = $dir."/codetable/";
    }
    ...
    function Convert( $source_lang , $target_lang , $source_string='' )
    {
    	...
    	// 判断是否为简体、繁体中文与UTF8转换
        if ( ($this->config['source_lang']=="GBK" || $this->config['source_lang']=="BIG5" || $this->config['source_lang']=="UTF8") && ($this->config['target_lang']=="UTF8" || $this->config['target_lang']=="GBK" || $this->config['target_lang']=="BIG5") ) {
            return $this->CHStoUTF8();
        }
