...
class WeiboWidget extends Widget {
	 ...
	 * <code>
	 * array(
	 * 	'page_title'(可选)	=> '弹出窗标题',		 // 默认为"分享到我的微广播"
	...
	public function render($data) {
		// 默认值
		$data['page_title']		= isset($data['page_title']) 		? $data['page_title'] 		: L('share_to_my_weibo');
		...
		$data['url']	= U('home/Widget/weibo',array('button_title'=>urlencode($data['button_title']),'tpl_name'=>$data['tpl_name'],'addon_info'=>$data['addon_info']));
