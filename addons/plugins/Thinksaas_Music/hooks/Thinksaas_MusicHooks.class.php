...
class Thinksaas_MusicHooks extends Hooks
{
	...
	{
		echo '<link href="' . $this->htmlPath . '/html/base.css" rel="stylesheet" type="text/css">';	//从public_head中转移过来
	...
	{
		$html = sprintf("<a href='javascript:void(0)' onclick='weibo.plugin.tsas.click(this)' class='a52'><img class='icon_add_music_d' src='%s' />音乐</a>", $this->htmlPath . "/html/zw_img.gif");
		echo $html;
	}
