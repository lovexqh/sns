...
//7.t/re_count 转播数  参数 $ids 的格式为: "第1条微广播id,第2条微广播id,第3条微广播id,........."   最多30个
...
//8.t/re_list 获取单条微广播的转发或点评列表  Flag:标识0 转播列表，1点评列表 2 点评与转播列表
...
//11.friends/check 检测是否是关注我的或偶像  flag 0:关注我  1：偶像
