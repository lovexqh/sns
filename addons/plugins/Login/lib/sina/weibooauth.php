...
{ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 用户UID或微广播昵称。 
     * @return array 
     */ 
     ...
     * @param mixed $uid_or_name 要获取的 UID或微广播昵称 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param bool $cursor 单页只能包含100个被关注列表，为了获取更多则cursor默认从-1开始，通过增加或减少cursor来获取更多关注我的列表 
     * @param bool $count 每次返回的最大记录数（即页面大小），不大于200,默认返回20。 
     * @param mixed $uid_or_name  要获取的 UID或微广播昵称 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 要关注的用户UID或微广播昵称 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 要取消关注的用户UID或微广播昵称 
     * @return array 
     */ 
     ...
     * @param mixed $uid_or_name 指定用户UID或微广播昵称 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name UID或微广播昵称 
    ...
    /** 
     * 批量统计微广播的评论数，转发数，一次请求最多获取100个。 
     *  
     * @access public 
     * @param mixed $sids 微广播ID号列表，用逗号隔开 
     * @return array 
     */ 
