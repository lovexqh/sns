...
class RadioAddons extends SimpleAddons {
	...
	protected $author     = 'RJ-GRID';
	protected $site       = 'http://edns.ruijie-grid.com';
	protected $info       = '直播电台';
	...
	*/
	...
	public function home_index_left_tab($param){
		...
		echo '<li><a href="'.$url.'" ><span class="ico_side" style="background:url('.$this->url.'/html/images/ico.png) no-repeat; display:inline-block;"></span>我的电台</a></li>';
	}
