...
class PublicTypeHooks extends Hooks
{
    ...
    {
        $weibo_type = array('1', '2', '3', '4', '5', '7', '8');
        //处理默认值
        ...
        foreach($weibo_type as $value){
            if(in_array($value,$config['open'])){
            	echo '<script type="text/javascript" src="'.Addons::createAddonUrl('WeiboType','loadJs', array('type'=>$value)).'" charset="utf-8"></script>';
            }
        }
    }
...
//         }
        ...
        if(!defined('__PUBLIC__')){
	  	...
	  	$js = array(
	  	        ...
	  	        '2'=>array($this->path.'/html/blog.js'),
