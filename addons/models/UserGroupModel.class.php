...
class UserGroupModel extends Model {
	 ...
	 * @return array 用户组信息
	 */
	public function getUserGroupByMap($map = '', $field = '*', $order = '`order` ASC,user_group_id ASC') {
    ...
    public function getUserGroupIcon($uid) {
    	...
    	foreach ($user_group_link as $v) {
    		if ($user_group[$v['user_group_id']]['icon'])
    			$html .= "<img class='ts_icon' src=".THEME_URL."/member/images/usergroup/".$user_group[$v['user_group_id']]['icon']." title=".$user_group[$v['user_group_id']]['title'].">";
    	}
