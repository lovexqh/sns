...
$lang = array(
	...
	'note_succeed' => '通知成功 ',
	'note_false' => '通知失败',
	'no_permission_for_this_module' => '没有权限管理该模块',
	'admin_user_exists' => '该用户名已经存在，请返回尝试使用其他用户名。',
    'admin_role_exists' => '该角色名已经存在，请返回尝试使用其他角色名。',
	'admin_dept_exists' => '该部门名已经存在，请返回尝试使用其他部门名。',
	'admin_userno_exists' => '该学号已经存在，请返回尝试使用其他学号。',
	'admin_useridentity_exists' => '该身份证号已经存在，请返回尝试使用其他身份证。',
	
	'admin_xxdm_exists' => '该学校代码已经存在，请返回核查。',
	'admin_xxmc_exists' => '该学校名称已经存在，请返回核查。',
		
	'admin_zyh_exists' => '该专业号已经存在，请返回核查。',
	'admin_zymc_exists' => '该专业名称已经存在，请返回核查。',
	
	'admin_njmc_exists'=>'该级部名称已经存在，请返回核查',
	'admin_nj_exists'=>'该级部已经存在，请返回核查',	

	'admin_bzrgh_exists' => '该班主任工号已经存在，请返回核查。',
	'admin_bh_exists' => '该班号已经存在，请返回核查。',
