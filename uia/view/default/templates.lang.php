...
$languages = array(
	...
	'menu_manager_role'=>'角色管理',
	'menu_manager_roster'=>'匹配信息管理',
	'menu_manager_dept'=>'部门管理',
	'menu_manager_specialty'=>'专业管理',
	'menu_manager_school'=>'学校信息管理',
	'menu_manager_class'=>'班级信息管理',
	'menu_manager_grade'=>'级部信息管理',
	...
	'app_url' => '应用的主 URL',
	'app_url_comment' => '该应用与统一身份通信的接口 URL，结尾请不要加“/” ，应用的通知只发送给主 URL',
	'app_extra_url' => '应用的其他 URL',
	'app_extra_url_comment' => '该应用可以访问的其他 URL，结尾请不要加“/” ，每行一个，只有在同步登录是请求该 URL',
	'app_ip' => '应用 IP',
	'app_ip_comment' => '正常情况下留空即可。如果由于域名解析问题导致统一身份与该应用通信失败，请尝试设置为该应用所在服务器的 IP 地址。',
	'app_key' => '通信密钥',
	'app_key_comment' => '只允许使用英文字母及数字，限 64 字节。应用端的通信密钥必须与此设置保持一致，否则该应用将无法与统一身份正常通信。',
	'app_login' => '是否开启同步登录',
	...
	'app_code' => '应用的配置信息',
	'app_code_comment' => '当应用的统一身份配置信息丢失时可复制左侧的代码到应用的配置文件中',
	...
	'menu_manager_identity'=>'身份管理',
	'identity_search' => '搜索身份',
	'identity_list' => '身份列表',
	'user_identity' => '添加身份',
	'identity_img' => '身份图标',
	...
	'role_list' => '角色列表',
	'dept_list' => '部门列表',
	'dept_tree_list' => '部门树状列表',
	'user_add_succeed' => '成功添加用户。',
	'grade_add_succeed' => '成功添加级部。',
	'class_add_succeed' => '成功添加班级。',
	'school_add_succeed' => '成功添加学校。',
	'dept_add_succeed' => '成功添加部门。',
	'user_delete_confirm' => '该操作不可恢复，您确认要删除这些用户吗？',
	'role_delete_confirm' => '该操作不可恢复，您确认要删除这些角色吗？',
	'roleFunc_sel_confirm' => '确定为该角色分配这些功能点吗？',
	'roleFunc_del_confirm' => '该操作不可恢复，您确认要删除该角色的这些功能点吗？',
	'school_delete_confirm' => '该操作不可恢复，您确认要删除这些学校信息吗？',
	'specialty_delete_confirm' => '该操作不可恢复，您确认要删除这些专业信息吗？',
	'grade_delete_confirm' => '该操作不可恢复，您确认要删除这些级部信息吗？',
	'class_delete_confirm' => '该操作不可恢复，您确认要删除这些班级信息吗？',
	'roster_delete_confirm' => '该操作不可恢复，您确认要删除这些匹配用户信息吗？',
	'dept_delete_confirm' => '删除前请确保该部门下无下级部门，该操作不可恢复，您确认要删除这些部门及其下属部门吗？',
	'user_delete_succeed' => '成功删除用户',
	'grade_delete_succeed' => '成功删除级部',
	'class_delete_succeed' => '成功删除班级',
	'school_delete_succeed' => '成功删除学校',
	...
	'user_add_role_ignore' => '角色名不合法',
	'user_add_role_exists' => '角色名已存在',
	'user_add_role_succeed' => '角色添加成功',

	'class_bh_exists'=>'班号已经存在',
	'class_bh_null'=>'班号不能为空',
	'class_bj_illegal'=>'班级名称不合法',
	'class_bzrgh_exists'=>'班主任工号已经存在',
	'class_bzxh_exists'=>'班长学号已经存在',
	'class_bzxh_null'=>'班长学号不能为空',
	'class_bzrgh_null'=>'班主任工号不能为空',

	'grade_name_illegal'=>'级部名称不合法',
	'grade_name_exists'=>'级部名称已存在',
	'grade_grade_null'=>'级部不能为空',
	'grade_xxid_null'=>'学校id不能为空',

	'school_name_illegal'=>'学校名称不合法',
	'school_name_exist'=>'学校名称已存在',
	'school_email_illegal'=>'电子信箱格式不正确',
	'school_tel_illegal'=>'请输入正确的电话号码',
	'school_xxdm_exist'=>'学校代码已经存在',
	'school_xxdm_null'=>'学校代码不能为空',
	'school_yzbm_illegal'=>'邮政编码格式不正确',
	'school_xxdz_null'=>'学校地址不能为空',
	'school_xzxm_null'=>'校长姓名不能为空',

	'identity_delete_succeed' => '成功删除身份',
	'identity_add_succeed' => '成功添加身份',
	'identity_add_failed' => '添加身份失败',
	'identity_add_ignore' => '该身份名不合法',
	'identity_add_exists' => '该身份已经存在',
	'uc_identity_check_icon_failed' => '角色图标上传失败',
	'uc_identity_check_icon_exits' => '角色图标已存在',
	'uc_identity_check_icon_type_failed' => '角色图标类型或图标大小超过限制',

	'uc_role_check_icon_failed' => '角色图标上传失败',
	'uc_role_check_icon_exits' => '角色图标已存在',
	'uc_role_check_icon_type_failed' => '角色图标类型或图标大小超过限制',


	'user_add_dept_ignore' => '部门名不合法',
	'user_add_dept_exists' => '部门名已存在',
	'user_add_updept_ignore' => '上级部门不合法',

	'user_add_realname_ignore' => '请输入真实姓名',
	'user_add_rolid_ignore' => '请选择所属角色',
	'user_add_deptid_ignore' => '请选择所属部门',
	'user_add_userno_ignore' => '请输入证件号码',
	'user_add_userno_exists' => '该证件号码已经存在',
	...
	'role_edit_profile' => '编辑角色资料',
	'class_edit_profile' => '编辑班级资料',
	'school_edit_profile' => '编辑学校资料',
	'identity_edit_profile' => '编辑身份资料',
	'user_edit_profile_sucessfully' => '编辑用户资料成功',
	'user_edit_profile_failed' => '编辑用户资料失败',
	'user_keep_blank' => '密码留空，保持不变。',
	'user_role_list' => '用户已有角色',
	'user_optRole_list' => '可选角色',

	'role_edit_profile_failed' => '编辑角色资料失败',
	'role_exit_profile_failed' => '角色名已经存在',
	'role_edit_profile_sucessfully' => '编辑角色资料成功',

	'identity_edit_profile_failed' => '编辑身份资料失败',
	'identity_exit_profile_failed' => '该身份已经存在',
	'identity_edit_profile_sucessfully' => '编辑身份资料成功',

	'roster_edit_profile_sucessfully' => '匹配信息资料修改成功',
	'class_edit_profile_sucessfully' => '班级信息资料修改成功',
	'class_edit_profile_failed' => '班级信息资料修改失败',
	'class_exit_profile_failed' => '班级已经存在',
	'grade_edit_profile_sucessfully' => '级部信息资料修改成功',
	'grade_edit_profile_failed' => '级部信息资料修改失败',
	'grade_exit_profile_failed' => '级部已经存在',
	'school_edit_profile_sucessfully'=>'学校信息资料修改成功',
	'school_edit_profile_failed' => '学校信息资料修改失败',
	'school_exit_profile_failed' => '学校已经存在',

	'dept_exit_profile_failed' => '部门名已经存在',
	'deptid_exit_profile_failed' => '上级部门不能为空',

	'dept_edit_profile_sucessfully' => '编辑部门资料成功',
	'dept_edit_profile_failed' => '编辑部门资料失败',

	'dept_edit_profile' => '编辑部门资料',
	'cache_update' => '更新缓存',
	...
	'db_delete_dumpfile_confirm' => '删除数据库备份会同时删除统一身份应用下所有应用的同目录下的备份，您确定要删除吗？',
	...
	'admin_founder_pw_incorrect' => '超级管理员账号密码输入错误',
	'admin_pw_incorrect' => '两次输入的密码不一致',
	'admin_pw_oldpw' => '请输入原超级管理员密码',
	'admin_pw_newpw' => '请输入新密码',
	'admin_pw_newpw2' => '请重复输入新密码',
	'admin_pw_too_short' => '您的密码太短，可能会不安全，您确定设定此密码吗？',
	'admin_founder_pw_modified' => '超级管理员账号密码修改成功',
	'admin_add_admin' => '添加管理员',
	'admin_modify_founder_pw' => '修改超级管理员密码',
	'admin_privilege' => '权　限',
	...
	'admin_return_role_ls' => '返回角色列表',
	'admin_return_identity_ls' => '返回身份列表',
	'admin_return_dept_ls' => '返回部门列表',
	'admin_return_class_ls' => '返回班级信息列表',
	'admin_return_grade_ls'=>'返回级部信息列表',
	'admin_return_school_ls' => '返回学校信息列表',
	'admin_return_roster_ls' => '返回用户匹配信息列表',
	'view_new_version' => '查看最新版本',

	'app_allowips' => '允许的IP',
	'app_allowips_comment' => '限定终端访问的IP, 设置哪些IP可以访问统一身份的数据接口',
    'select' => '请选择',
	'top_dept' => '顶级部门',
	'DeptLevel' => '部门等级',
	'Level_select' => '请选择',
	...
	'DeptManager' => '部门负责人',
	'DeptStruct' => '部门结构图',
	'roster_search' => '搜索验证用户',
	'roster_name' => '用户名',
	'roster_identity' => '身份证号',
	'roster_userno' => '学号',
	'read_excel' => '添加数据表',
	'select_excel' => '选择数据表',
	'uc_roster_failed' => '数据表类型或者文件大小超过2M',
	'roster_add_succeed' => '数据表添加成功',
	'roster_add' => '添加用户',
	'roster_list' => '用户验证信息列表',
	'roster_name' => '用户名',
	'roster_classname' => '用户班级',
	'roster_seatno' => '用户座号',
	'roster_sex' => '用户性别',
	'roster_userno' => '用户学号',
	'roster_nation' => '民族',
	'roster_add_succeed' => '用户添加成功',
	'roster_classname' => '用户班级',
	'roster_sex' => '性别',
	'roster_sex_female' => '女',
	'roster_sex_male' => '男',
	...
	'class_wllx'=>'文理类型',
	'class_byrq'=>'毕业日期',
	'class_sfssmzsy'=>'是否少数民族双语教学班',
	'class_syjxmsm'=>'双语教学模式码',
	'class_add_succeed' => '班级添加成功',
	'class_add_failed' => '添加班级失败',
	'class_delete_succeed' => '成功删除用户',
	'class_add_failed' => '添加用户失败',
		
	'specialty_search'=>'搜索专业',
	'specialty_add'=>'添加专业',
	'specialty_zymc'=>'专业名称',
	'specialty_list'=>'专业信息列表',
	'specialty_zyh'=>'专业号',
	'specialty_zyjc'=>'专业简称',
	'specialty_yxid'=>'院系id',	
	'specialty_ssyx'=>'所属院系',
	'specialty_xjzyh'=>'校级专业号',
	'specialty_xjzym'=>'校级专业名',
	'specialty_zyywmc'=>'专业英文名称',
	'specialty_xz'=>'学制',
	'specialty_xkmlm'=>'学科门类码',
	'specialty_zyccm'=>'专业层次码',
	'specialty_jlny'=>'建立年月',
	'specialty_zyjj'=>'专业简介',
	'admin_return_specialty_ls' => '返回专业信息列表',
	'specialty_edit_profile_sucessfully'=>'专业信息资料修改成功',
	'specialty_edit_profile_failed' => '专业信息资料修改失败',
	'specialty_exit_profile_failed' => '专业已经存在',
	'specialty_edit_profile' => '编辑专业资料',
	'specialty_detail_profile'=>'专业详细信息',
	'admin_return_specialty_ls' => '返回专业信息列表',
	...
	'school_detail_profile'=>'学校详细信息',
	'user_detail_profile'=>'用户基本信息',
	'school_list'=>'学校信息列表',
	'school_add' => '添加学校',
	'school_search' => '搜索学校',
	'school_xxdm'=>'学校代码',
	'school_xxmc'=>'学校名称',
	'school_xxywmc'=>'学校英文名称',
	'school_xxdz'=>'学校地址',
	'school_xxyzbm'=>'邮政编码',
	'school_xzqhm'=>'行政区划码',
	'school_jxny'=>'建校年月',
	'school_xqr'=>'校庆日',
	'school_xxbxlxm'=>'学校办学类型码',
	'school_xxzgbmm'=>'学校主管部门码',
	'school_fddbrh'=>'法定代表人号',
	'school_frzsh'=>'法人证书号',
	'school_xzgh'=>'校长工号',
	'school_xzxm'=>'校长姓名',
	'school_dwfzrh'=>'党委负责人号',
	'school_zzjgm'=>'组织机构码',
	'school_lxdh'=>'联系电话',
	'school_czdh'=>'传真电话',
	'school_dzxx'=>'电子信箱',
	...
	'school_lsyg'=>'历史沿革',
	'school_xxbbm'=>'学校办别码',
	'school_sszgdwm'=>'所属主管单位码',
	'school_szdcxlxm'=>'所在地城乡类型码',
	'school_szdjjsxm'=>'所在地经济属性码',
	'school_szdmzsx'=>'所在地民族属性',
	'school_xxxz'=>'小学学制',
	'school_xxrxnl'=>'小学入学年龄',
	'school_czxz'=>'初中学制',
	'school_czrxnl'=>'初中入学年龄',
	'school_gzxz'=>'高中学制',
	'school_zjxyym'=>'主教学语言码',
	'school_fjxyym'=>'辅教学语言码',
	'school_zsbj'=>'招生半径',
	'school_add_succeed' => '学校添加成功',
	'school_add_failed' => '添加学校失败',
	'user_add_school_succeed' => '学校添加成功',
	'school_delete_succeed' => '成功删除学校',
);