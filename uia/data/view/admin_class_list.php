...
<div style="width:100%;height:30px;padding:5px 0px;clear:both;border:0px;background:none;">
    <div style="width:50%;float:left;text-align:left;">
        ...
        <div style="width:50%;float:left;text-align:right;">
			<input id="key" class="mini-textbox" emptyText="请输入班级名称" style="width:150px;" onenter="onKeyEnter"/>   
            <a class="mini-button" onclick="search()">查询</a>
		</div>            
</div>
<!--Layout-->
<div id="datagrid1" class="mini-datagrid" style="width:100%;height:92%;"
url="admin.php?m=class&a=getClassList&eid=<?php echo $data['eid'];?>&ss=<?php echo $data['ss'];?>" idField="id" pageSize="50" multiSelect="true" >
	<div property="columns">
		<div type="checkcolumn"></div>
		<div field="bm" width="120" headerAlign="center">班名</div>
		<div field="jbny" width="60" headerAlign="center">建班年月</div>
		<div field="ssnj" width="60" headerAlign="center">所属年级</div>
		<div field="bjlx" width="120" headerAlign="center">班级类型</div>
...
<script type="text/javascript">
    ...
    function newRow() {            
    	 mini.open({
             url: "admin.php?m=class&a=ClassAdd&zyid=<?php echo $data['eid'];?>",
             title: "添加班级信息", width: 785, height: 265,
             onload: function () {
    ...
    function editRow(row_uid) {
         ...
         if (row) {
             mini.open({
                 ...
                 url: "admin.php?m=class&a=ClassAdd&id="+row.id,
                 title: "编辑班级信息", width: 785, height: 265,
                 onload: function () {
                     var iframe = this.getIFrameEl();
    ...
    function delRow(row_uid) {
        ...
        if (rows.length > 0) {
            if (confirm("确定删除选中记录？")) {
                ...
                $.ajax({
                	url: "admin.php?m=class&a=delClass",
                	type: 'POST',
    				data : {
    					classid : id
    				},
