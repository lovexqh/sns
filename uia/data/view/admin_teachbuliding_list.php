...
url="admin.php?m=teachbuliding&a=getTeachbulidingList&eid=<?php echo $data['eid'];?>&ss=<?php echo $data['ss'];?>" idField="id" pageSize="50" multiSelect="true" >
...
<script type="text/javascript">
    ...
    function newRow() {            
    	 mini.open({
             url: "admin.php?m=teachbuliding&a=TeachbulidingAdd&schoolid=<?php echo $data['eid'];?>",
