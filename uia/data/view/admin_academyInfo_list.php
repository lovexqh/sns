...
url="admin.php?m=college&a=getCollegeList&eid=<?php echo $data['eid'];?>&ss=<?php echo $data['ss'];?>" idField="id" pageSize="50" multiSelect="true" >
...
<script type="text/javascript">
    ...
    function newRow() {            
    	 mini.open({
             url: "admin.php?m=college&a=collegeAdd&xxid=<?php echo $data['eid'];?>",
