...
url="admin.php?m=teacher&a=getTeacherList&schoolid=<?php echo $data['schoolid'];?>&deptIdNull=<?php echo $data['deptIdNull'];?>" idField="identityid" pageSize="50" multiSelect="true" >
