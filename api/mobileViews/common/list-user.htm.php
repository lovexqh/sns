                        ...
                        <div class="middle">
                            <div class="right">
                                ...
                                switch($v['user']['is_followed']){
                                    case 'eachfollow':
                                        echo '<span data-follow="no" data-uid='.$v['user']['uid'].' class="follow-status">相互关注</span>';
                                        break;
                                    case 'havefollow':
                                        echo '<span data-follow="no" data-uid='.$v['user']['uid'].' class="follow-status">已关注</span>';
                                        break;
                                    case 'unfollow':
                                        echo '<span data-follow="add" data-uid='.$v['user']['uid'].' class="follow-status">加关注</span>';
                                        break;
                                }
                                ?>
                            </div>
                            ...
                            <div class="info">
                                <span class="info-w">微博<span class="count"><?php echo $v['user']['weibo_count'];?></span></span>
                                <span class="info-follow">关注<span class="count"><?php echo $v['user']['followed_count'];?></span></span>
                                <span class="info-fans">粉丝<span class="count"><?php echo $v['user']['followers_count'];?></span></span>
                            </div>
            ...
            success:function(data){
                ...
                for(var i in data){
                    ...
                    switch(data[i]['user']['is_followed']){
                        case 'eachfollow':
                            html +='<span data-follow="no" data-uid='+data[i]['user']['uid']+' class="follow-status">相互关注</span>';
                            break;
                        case 'havefollow':
                            html += '<span data-follow="no" data-uid='+data[i]['user']['uid']+' class="follow-status">已关注</span>';
                            break;
                        case 'unfollow':
                            html += '<span data-follow="add" data-uid='+data[i]['user']['uid']+' class="follow-status">加关注</span>';
                            break;
                    }
                    html += '</div>';
