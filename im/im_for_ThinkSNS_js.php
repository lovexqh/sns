...
// for ThinkSNS
require("plugins/plugin_for_ucenter.php");
...
if(!$uid) {
	...
	if(!$user_row) {
		!$row['u_ico'] && $row['u_ico'] = $siteDomain.'skin/default/images/d_ico_0_small.gif';
...
//$language_basic[Jooyea]=empty($_SESSION[uname])?$language_basic[Jooyea]:$_SESSION[uname];
...
document.write("    			<h2><img src='<?php echo $siteDomain?>im/skin/default/images/im_version.gif' alt='IM v1.0' width='83' height='16'/></h2>");
document.write("    			<p> <a href='javascript:void(0);' onclick=\"i_im_show('im_tinybar');i_im_show('imbar');\"><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_min.gif' alt='"+i_im_lang_basic.Min+"' /></a></p>");
document.write("    			<p><a href='javascript:void(0);' onclick=\"i_im_show('imbar')\"><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_max.gif' alt='"+i_im_lang_basic.Close+"' /></a></p>");
document.write("  			</div>");
...
document.write("						<div class=\"content_pop\">");
document.write("							<ul id=\"imsearch_dorpList\">");
document.write("								<li><span>"+i_im_lang_basic.InputName+"</span></li>");
document.write("							</ul>");
document.write("						</div>");
document.write("					</div>");
document.write("				</div>");
...
document.write("				</div>");
document.write("  			</div>");
document.write("  			<div class='imBottombar' onclick=\"i_im_readyBlur('imbar');i_im_setOnShowPara('imbar');\"> <img onclick=\"i_im_setting();\" src='<?php echo $siteDomain?>im/skin/default/images/im_icon_manage.gif' alt='"+i_im_lang_basic.SysSetting+"' title='"+i_im_lang_basic.SysSetting+"' width='28' height='28' class='pointer' /> </div>");
document.write("		</div>");
...
document.write("    		<p class='imIcons'><span onclick='i_im_closeSetting()'><a href='javascript:void(0);'><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_max.gif' alt='"+i_im_lang_basic.Close+"' /></a></span> </p>");
document.write("  		</div>");
...
document.write("          					<tr>");
document.write("            					<td><img id='settingheadimg' src='<?php echo $siteDomain?>im/skin/default/images/img_friend4.jpg' alt='' width='40' height='40' /></td>");
...
document.write("	<div id='im_container' class='imCrSW' style='position:fixed;top:0px;left:0px;'></div>");
...
document.write("						<span><a href='javascript:void(0);' id='dlgCloseBtn{imwin_id}'><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_max.gif' alt='"+i_im_lang_basic.Close+"' /></a></span> ");
document.write("					</p>");
document.write("	      		</div>");
document.write("	      		<div id='list_btns{id}' class='list_btns'>");
document.write("	        		<ul>");
document.write("	          			<li><a href='javascript:void(0);' onclick=\"openvideo('{pals_id}','p')\"><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_video.gif' alt='"+i_im_lang_talkwin.Video+"' title='"+i_im_lang_talkwin.Video+"' /></a></li>");
...
document.write("						</form>");
document.write("			  			</li>");
document.write("			  			<li><span onclick=\"i_im_addFriends('{imwin_id}',this)\"><img alt='"+i_im_lang_talkwin.BecomeFriend+"' src='<?php echo $siteDomain?>im/skin/default/images/im_icon_invited.gif' title='"+i_im_lang_talkwin.BecomeFriend+"'></span></li>");
document.write("	        		</ul>");
document.write("	      		</div>");
...
document.write("	            			<p class='im_expression'><a href='javascript:void(0);' onclick=\"i_im_show('face_list_menu{imwin_id}')\"><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_expression.gif' alt='"+i_im_lang_talkwin.SearchFace+"' title='"+i_im_lang_talkwin.SearchFace+"' /></a></p>");
document.write("	            			<p class='im_expression'><a href='javascript:void(0);' title=\""+i_im_lang_talkwin.TransferImg+"\" class=\"postimg\"><img src='<?php echo $siteDomain?>im/skin/default/images/im_icon_pic.gif' alt='"+i_im_lang_talkwin.TransferImg+"' /></a></p>");
...
document.write("							</form>");
document.write("	            			<p class='im_expression'><a href='javascript:void(0);' hidefocus='true' onclick=\"document.getElementById('message_content_{id}').innerHTML=''\"><img src='<?php echo $siteDomain?>im/skin/default/images/brush.gif' alt='"+i_im_lang_talkwin.ClearWindow+"' title='"+i_im_lang_talkwin.ClearWindow+"' /></a></p>");
...
{ 
	...
	img.src= '<?php echo $baseUrl; ?>skin/default/images/talk20.gif';
	img.onerror=null;
}