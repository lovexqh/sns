...
weibo.prototype = {
	...
	share:function(id, gid, upcontent){
		upcontent = ( upcontent== undefined ) ? 1 : 0;
		ui.box.load( U("group/WeiboOperate/shareWeibo",["id="+id,"gid="+gid,"upcontent="+upcontent] ),{title:'分享到我的微广播',closeable:true});
	},
	// 关注话题
	...
	quickpublish:function(text, gid){
		$.post(U('weibo/operate/quickpublish'),{gid:gid,text:text},function(txt){
