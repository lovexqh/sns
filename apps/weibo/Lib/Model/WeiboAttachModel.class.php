...
class WeiboAttachModel extends Model{
	...
	//获取微广播相册
    //获取字段修改——徐程亮 13-6-28 上午9:27
	public function getWeiboAlbum($uid,$field=false){
        ...
        if($field){
            ...
            $weibo  =  array(
                ...
                "name" => "微广播相册",
                "info" => '',
                "cTime" =>  date('Y-m-d H:i:s',$last_weibo_attach['uploadTime']),
                "mTime" =>  date('Y-m-d H:i:s',$last_weibo_attach['uploadTime']),
