	...
	public function operate(){
		...
		if($strType=='del'){
			...
			foreach($weibo_ids as $weibo_id){
				...
				if( $isDel['isdel'] ){
					$data[] = '应用 - 应用配置 - 微广播 - 微广播回收站';
				}else{
					$data[] = '应用 - 应用配置 - 微广播 - 微广播列表';
				}
