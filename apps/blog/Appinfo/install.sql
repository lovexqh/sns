...
VALUES
    ('blog_create_weibo','发表博客','','我发表了一篇博客:【{title}】 {url}','zh','blog','weibo',0,1290417734),
    ('blog_share_weibo','分享博客','','分享@{author} 的博客:【{title}】 {url}','zh','blog','weibo',0,1290595552);
...
REPLACE INTO `ts_system_data` (`uid`,`list`,`key`,`value`,`mtime`) 
VALUES (0,'blog','version_number','s:5:"36263";','2012-07-12 00:00:00');