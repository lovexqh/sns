...
return array(
	...
	// 应用图标 [必填]
	'ICON_URL'					=> SITE_URL . '/apps/favorite/Appinfo/ico_app.png',
	// 应用图标 [必填]
	'LARGE_ICON_URL'			=> SITE_URL . '/apps/favorite/Appinfo/ico_app_large.png',
	// 版本号 [必填]
	...
	'AUTHOR_NAME'				=> 'Ricker',
	// 作者Email [必填]
	'AUTHOR_EMAIL'				=> 'Rickeryu@gridinfo.com.cn',
	// 作者主页 [选填]
	'AUTHOR_HOMEPAGE_URL'		=> '',
	// 贡献者姓名 [选填]
	'CONTRIBUTOR_NAMES'			=> 'Rickeryu',
);