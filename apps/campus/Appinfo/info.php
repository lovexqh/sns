...
return array(
	...
	'APP_ENTRY'					=> 'Index/my',
	// 应用图标 [必填]
	'ICON_URL'					=> SITE_URL . '/apps/campus/Appinfo/ico_app.png',
	// 应用图标 [必填]
	'LARGE_ICON_URL'			=> SITE_URL . '/apps/campus/Appinfo/ico_app_large.png',
	// 版本号 [必填]
	'VERSION_NUMBER'			=> '36263',
	// 后台入口 [选填]
	'ADMIN_ENTRY'				=> 'Admin/index',
	// 统计入口 [选填]（格式：Model/method）
	'STATISTICS_ENTRY'			=> 'campusStatistics/statistics',
	// 应用的主页 [选填]
	'HOMEPAGE_URL'				=> '',
	// 应用类型
	'CATEGORY'					=> '工具',
	...
	'AUTHOR_NAME'				=> '小朱',
	// 作者Email [必填]
	'AUTHOR_EMAIL'				=> 'ruijie-grid@gmail.com',
	// 作者主页 [选填]
	'AUTHOR_HOMEPAGE_URL'		=> '',
	// 贡献者姓名 [选填]
	'CONTRIBUTOR_NAMES'			=> '锐杰网格',
);
?>