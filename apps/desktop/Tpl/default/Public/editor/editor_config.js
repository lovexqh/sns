...
(function () {
	...
	window.UEDITOR_HOME_URL='dzz/ueditor/editor/';
    ...
    UEDITOR_CONFIG = {
        ...
        toolbars:[
            ['Openfile','Savefile','Savetofile','Openimg',
			 'Source', '|', 'Undo', 'Redo', '|',
        ...
        labelMap:{
			'openfile':'打开文件','savefile':'保存文件','savetofile':'另存为','openimg':'插入云桌面图片','openvideo':'插入云桌面视频',
            ...
            'fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式', 'insertimage':'网络图片', 'inserttable':'表格', 'link':'超链接',
            'emotion':'表情', 'spechars':'特殊字符', 'searchreplace':'查询替换', 'map':'Baidu地图', 'gmap':'Google地图',
            'insertvideo':'网络视频', 'help':'帮助', 'justifyleft':'居左对齐', 'justifyright':'居右对齐', 'justifycenter':'居中对齐',
        ...
        messages:{
            ...
            wordCountMsg:'当前已输入 {#count} 个字符', //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数。
...
//            var block = X(inline, {p:1,div:1,blockquote:1,$:{style:1,dir:1}});
            return {
                ...
                blackList:{style:1, link:1, object:1, applet:1, input:1, meta:1, base:1, button:1, select:1, textarea:1, '#comment':1, 'map':1, 'area':1,'script':1}
//                whiteList: {
