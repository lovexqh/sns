(function (){
    ...
    var btnCmds = [
		'Openfile','Savefile','Savetofile','Openimg','Attachment','Openvideo',
    ...
    var dialogCmds = ['Anchor','Link', 'InsertImage', 'Map', 'GMap', 'InsertVideo','TableSuper','HighlightCode','InsertFrame','EditTd'];
