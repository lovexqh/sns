...
function uploadSuccess(file, serverData) {
	try {
		...
		for(var i =0;i<result.length;i++){
			...
			document.getElementById("savename").value = jsonobj['savename'];
			document.getElementById("savepath").value = jsonobj['savepath'];
			document.getElementById("extension").value = jsonobj['extension'];
			document.getElementById("size").value = jsonobj['size'];
			document.getElementById("thumb").value = jsonobj['thumb'];
			document.getElementById("swffile").value = jsonobj['swffile'];
		 }
	} catch (ex) {
		this.debug(ex);
	}
