...
function square_index_weibo(url){
	...
	//setTimeout(function(){if($square_list.html()=='')$square_list.html('<span style="margin:100px 42%;">获取微广播失败！</span>');},10000);
	$.post(url,{},function(html){
		if(html == -1){
			$square_list.html('<span style="margin:100px 50%;">微广播列表为空！</span>');
		}else if(html){
