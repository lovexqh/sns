...
class IndexAction extends BaseAction {
	...
	public function weibo() {
        ...
        if($this->mid==$this->uid){
        	$this->assign('headtitle', '我的微广播');
        }else {
        	$this->assign('headtitle', $this->profile['status']['uname'].'的微广播');
        }
	...
	public function followers() {
		if($this->uid==$this->mid){
			$this->assign('headtitle', '关注我的');
		}else{
			$this->assign('headtitle', '关注'.getUserName($this->uid).'的');
		}
