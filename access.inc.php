...
return array(
	"access"	=>	array(
		...
		'wap/*/*'					=> true, // Wap版
        'w3g/*/*'					=> true, // 3G版
		'home/Square/*'				=> true, // 微广播广场的权限由管理后台控制
		'home/Widget/selectSchool'	=> true, // 选择学校
		'weibo/user/topics'			=> true, // 话题列表

		'home/Widget/renderWidget' 	=> true, // 未登录时渲染插件
		'home/Widget/addonsRequest' => true, // 未登录时下调用钩子相关操作
		'home/Widget/weiboShow'		=> true, // 小工具：微广播秀
		'home/Widget/share'			=> true, // 小工具：站外分享
		'home/Widget/webpageComment'=> true, // 小工具：微广播评论框
		'home/Tree/*'				=> true, // 树状结构
		//博客配置
		...
		//社团配置
		'group/Index/index'			=> true, // 社团首页
		'group/Index/newIndex'		=> true, // 社团首页
		'group/Index/search'		=> true, // 分类列表
		'group/Group/index'			=> true, // 单群首页
				
		//视频应用
		'video/Server/*'			=> true,//服务接口
	)
);