...
function build_runtime() {
	...
	// 定义核心编译的文件
    $runtime[]  =  CORE_PATH.'/sociax/functions.php';	// 系统函数
	$runtime[]  =  CORE_PATH.'/sociax/extend.php';		// 扩展函数库
    ...
    if (!defined('NO_CACHE_RUNTIME')) define('NO_CACHE_RUNTIME', false);
...
class IndexAction extends Action{
    public function index(){
        ...
        echo "<div style=\'font-weight:normal;color:blue;float:left;width:345px;text-align:center;border:1px solid silver;background:#E8EFFF;padding:8px;font-size:14px;font-family:Tahoma\'>Hello,欢迎使用<span style=\'font-weight:bold;color:red\'>Sociax!</span></div>";
    }
}
?>';
