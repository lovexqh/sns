...
return  array(
    ...
    /* Cookie设置 */
    'COOKIE_EXPIRE'         => 24*3600,		// Coodie有效期
    ...
    'ERROR_PAGE'			=> U('home/Public/error404'),	// 错误定向页面
    ...
    /* 文章设置 */
    'LOG_RECORD'            => false,   // 默认不记录文章
    'LOG_FILE_SIZE'         => 2097152,	// 文章文件大小限制
    'LOG_RECORD_LEVEL'      => array('EMERG','ALERT','CRIT','ERR'),// 允许记录的文章级别
